"""
Phase 3 Notebook Generator — STANDALONE
Generates ONLY the Phase 3 lightweight notebooks.
Does NOT touch any existing Phase 1/2 notebooks.

Output:
  - federated_learning/setup1_natural_lightweight/notebook_setup1_lightweight.ipynb
  - federated_learning/setup2_label_skew_lightweight/notebook_setup2_lightweight.ipynb
"""
...
# ╔══════════════════════════════════════════════════════╗
# ║  Phase 3 Hyperparameters — Tunable Knobs            ║
# ╚══════════════════════════════════════════════════════╝
...
# ═══════════════════════════════════════════════════════════════
# GENERATE PHASE 3 NOTEBOOKS ONLY
# ═══════════════════════════════════════════════════════════════

BASE = "d:/Major_Project/FL_QPSO_FedAvg/federated_learning"

for setup_num, setup_name, setup_desc, data_prep in [
    (1, "setup1_natural_lightweight", "Phase 3 / Setup 1: Natural Heterogeneity — SimpleCNN + Dynamic-β QPSO", SETUP1_DATA_PREP),
    (2, "setup2_label_skew_lightweight", "Phase 3 / Setup 2: Moderate Label Skew — SimpleCNN + Dynamic-β QPSO", SETUP2_DATA_PREP),
]:
    cells = [
...
print("\n✅ Phase 3 notebooks generated! Existing notebooks were NOT touched.")
